 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".materials__wrapper-slider")) new swiper_core_Swiper(".materials__slider", {
            ...
            if (document.querySelector(".body-product__images")) {
                //! Previw Slider
                let thumbsSwiper = new swiper_core_Swiper(".image-preview__slider", {
                    modules: [ Autoplay, Thumb, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 6,
                    spaceBetween: 30,
                ...
                //! SWIPER SIZES
                                new swiper_core_Swiper(".sizes__slider", {
...
***************************************************************************** */
            ...
            function addActiveClass() {
                ...
                for (let i = 0; i < menuItems.length; i++) menuItems[i].addEventListener("click", (function() {
                    if (window.innerWidth > 767) {
                        for (let j = 0; j < menuItems.length; j++) menuItems[j].parentElement.classList.remove("_active-color");
        ...
        if (selectElement) {
            ...
            if (namePageInput) namePageInput.value = pageName; else console.error('Елемент з name="namePage" не знайдено на сторінці.');
            ...
            function copySelectedSizeOption() {
                ...
                if (selectElement) {
                    ...
                    if (selectedOption) {
                        if (prevCopiedSizeOption) prevCopiedSizeOption.remove();
